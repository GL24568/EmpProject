...
<body onload="startTime()">
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="#">用户登录</a></li>
			<li class="nav-item" >
	...
	<center>
		...
		<div class="container">
			<div style="height: 8px; width: 120px; text-align: center;">
				<span class="text-danger" style="font-size: 20px"> <strong>
						${result} ${checkcode_msg} </strong></span>
			</div>
			...
			<form class="form-signin" action="login.do" method="post">
				...
				<button class="btn btn-lg btn-primary " type="submit">Sign
					in</button>
				    &nbsp &nbsp &nbsp &nbsp<a href="regist.jsp"
					class="button btn btn-lg btn-primary">Regist</a>
			</form>
		</div>
	</center>
